class _BotCommands:
    def __init__(self):
        ...
        self.RssListCommand = 'rssl'
        self.RssGetCommand = 'rssg'
        self.RssSubCommand = 'rsss'
        self.RssUnSubCommand = 'rssuns'
        self.RssUnSubAllCommand = 'rssunsub9all'
